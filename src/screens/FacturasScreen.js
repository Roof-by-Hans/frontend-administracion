...
export default function FacturasScreen({ onNavigate, currentScreen }) {
    ...
    >
      <View style={[styles.container, isMobile && styles.containerCompact]}>
        ...
        <View style={styles.header}>
          <Text style={[styles.title, isMobile && styles.titleCompact]}>Gestionar Facturas</Text>
        </View>

        {/* Controles superiores */}
        <View style={styles.controlsContainer}>
          <View style={[styles.controlsRow, isMobile && styles.controlsRowCompact]}>
            {/* Buscador */}
            <View style={[styles.searchContainer, isMobile && styles.searchContainerCompact]}>
            ...
            {/* Filtro de estado */}
            <View style={[styles.filterContainer, isMobile && styles.filterContainerCompact]}>
              <TouchableOpacity
                style={[
                  styles.filterButton,
                  filtroEstado === "todas" && styles.filterButtonActive,
                  isMobile && styles.filterButtonCompact
                ]}
        ...
        >
          <Pressable style={styles.modalOverlay} onPress={handleCerrarModal}>
            <Pressable
              style={[styles.modalContent, isMobile && styles.modalContentCompact]}
